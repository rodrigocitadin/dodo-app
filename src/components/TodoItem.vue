...
const onDelete = ($evt) => {
  todos.deleteTodo(props.todo.id)
}
</script>
...
<template>
  <div class="bg-gray-300 rounded-sm">
    <div class="flex items-center px-4 py-3 border-b border-gray-400 last:border-b-0">
      ...
      <div class="w-full">
        <input @keyup.enter="onTitleChange" type="text" placeholder="Digite a sua tarefa" v-model="title"
